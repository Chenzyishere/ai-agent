      ...
      >
        <div className="flex items-center justify-between p-4">
          ...
          <button
            ...
            aria-label={isMobileMenuOpen ? '关闭目录' : '打开目录'}
            ...
            <div className="mt-16 flex flex-col items-center justify-between gap-6 border-t border-white/5 pt-8 text-sm text-gray-500 sm:flex-row">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex gap-2">
                  <button type="button" className="flex items-center gap-2 rounded-lg border border-white/10 bg-white/5 px-4 py-2 transition-all hover:border-green-500/30 hover:bg-white/10 hover:text-green-400">
                    <Check size={16} /> 是
                  </button>
                  <button type="button" className="flex items-center gap-2 rounded-lg border border-white/10 bg-white/5 px-4 py-2 transition-all hover:border-red-500/30 hover:bg-white/10 hover:text-red-400">
                    <X size={16} /> 否
                  </button>
                </div>
              </div>
