  ...
  return (
    <div className="flex h-screen w-screen flex-col">
      ...
      <div className="relative mx-auto flex w-screen justify-center gap-4">
        ...
        <div className="fixed top-1/6 right-2 h-1/2 w-1/7 overflow-hidden rounded-2xl border border-white/30 bg-white/30 shadow-[0_8px_32px_rgba(0,0,0,0.1)] backdrop-blur-xl transition-all duration-300">
          Setting
        </div>
